...
class SafetyGovernor(Node):
    ...
    def __init__(self) -> None:
        ...
        self.safety_radius = 3.0   # stay outside this radius
        self.circle_radius = 3.25  # follow this radius if avoidance is needed
        self.circle_active = False
        self.circle_center = np.zeros(2, dtype=float)
        self.circle_dir = 1  # +1 CCW, -1 CW
        self.circle_lookahead = 1.0  # meters along arc
    ...
    def cmdloop_callback(self) -> None:
        ...
        if not self.circle_active:
            ...
            # exit circle when the direct path is clear
