...
class SafetyGovernorNoAvoidance(Node):
    ...
    - 8 m/s max, 3.0 m/s à moins de 3 m d'un humain (default; configurable via ROS params).
    """
    ...
    def __init__(self) -> None:
        ...
        self.wp_a = np.array([-10, 0.0, -5.0], dtype=float)   # start
        self.wp_b = np.array([30.0, 0.0, -5.0], dtype=float)  # end
        ...
        self.safety_radius = 3.0   # m
        self.v_cap_near = 3.0      # m/s
        self.v_cap_free = 8.0      # m/s
